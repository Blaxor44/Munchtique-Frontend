...
export default {
  ...
  methods: {
    validatePasswords() {
      if (this.password !== this.repeatPassword || this.repeatPassword !== this.pass) {
              ...
              <div class="card-body p-5 text-center">
                <div class="mb-md-5 mt-md-4 pb-5">
                  <p class="navbar-brand">
                    <img src="\src\components\icons\donut2.png" alt="Logo" class="h-12" width="100" height="100" />
                  </p>
                  ...
                  <div data-mdb-input-init class="form-outline form-white mb-4">
                    <input v-model="repeatPassword" @input="validatePasswords" type="password" id="typeRepeatPasswordX" class="form-control form-control-lg" />
                ...
                <div>
                  <p class="mb-0">Already have an account? <router-link to="/login" class="text-white-50 fw-bold">Login</router-link></p>
                </div>
