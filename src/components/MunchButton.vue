  ...
  methods: {
    ...
    getIcons() {
      return [
        ...
        { index: 1, src: "/public/icons/hamburger.png", route: "Burger" },
        { index: 2, src: "/public/icons/tortilla.png", route: "Wrap" },
        { index: 3, src: "/public/icons/hotdog.png", route: "Hotdog" },
        { index: 4, src: "/public/icons/frenchfries.png", route: "French Fries" },
        { index: 5, src: "/public/icons/steak.png", route: "Meat" },
        { index: 6, src: "/public/icons/sushi.png", route: "Sushi" },
        { index: 7, src: "/public/icons/fruit.png", route: "Fruit" },
        { index: 8, src: "/public/icons/dessert.png", route: "Dessert" },
        { index: 9, src: "/public/icons/cola.png", route: "Drink" }
      ];
    }
  },
